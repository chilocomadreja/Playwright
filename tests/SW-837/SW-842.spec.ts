...
test.describe.skip('Weryfikacja zaleceń gwarantujących sukces', () => {
  ...
  test('1. Nowy', async ({ page }) => {
    ...
    ///Asert
    const Zalecenia = 'Przypisz potencjalnego klienta do przedstawiciela';
    ...
    const Zalecenia5 = 'Zalecenia gwarantujące sukces';
    expect(Zalecenia5).toContain('Zalecenia gwarantujące sukces');
  });
  ...
  test('2. Wstępna analiza', async ({ page }) => {
    ...
    const Zalecenia1 = 'Zalecenia gwarantujące sukces';
    expect(Zalecenia1).toContain('Zalecenia gwarantujące sukces');
  ...
  test('3. Niezakwalifikowny', async ({ page }) => {
    ...
    const Zalecenia5 = 'Zapisz szczegóły zasięgu i informacje kontaktowe ';
